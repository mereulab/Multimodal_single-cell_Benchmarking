...
if __name__ == "__main__":
    ...
    sc.tl.rank_genes_groups(adata, method='wilcoxon',groupby='Deepscore_HCA_l3_Clean', use_raw=False)
    ...
    for group in groups:
        ...
        df.to_csv(f'csv/l2/{tech}/DEG_{group1}.csv', index_label='Feature_name')
